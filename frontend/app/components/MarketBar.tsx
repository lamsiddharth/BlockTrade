      ...
      <div className="flex items-center justify-between flex-row no-scrollbar overflow-auto pr-4">
        ...
        <div className="flex items-center flex-row space-x-8 pl-4">
          ...
          <div className="flex flex-col">
            ...
            <p className={`text-sm font-medium tabular-nums leading-5 ${Number(ticker.priceChange) > 0 ? "text-green-500" : "text-red-500"}`}>
          ...
          <button type="button" className="font-medium transition-opacity hover:opacity-80 hover:cursor-pointer text-base text-left">
            <div className="flex flex-col">
